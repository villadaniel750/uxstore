  ...
  <v-dialog v-model="dialog" fullscreen :scrim="false" transition="dialog-bottom-transition">
      ...
      <v-card>
        <v-toolbar dark :color="this.responseOk ? 'green' : 'primary'">
          ...
          <v-toolbar-title class="text-button">EarnLumens Priority Access</v-toolbar-title>
          <v-spacer></v-spacer>
        </v-toolbar>
        <v-list lines="two" subheader>
          <div :style="mobileView ? '' : 'display: flex; justify-content: center; align-items: center; flex-direction: column;'">
            <v-list-item title="JOIN OUR WAITING LIST" :disabled="isLoading"></v-list-item>
            <v-list-item-group>
              <v-list-item>
              ...
              <v-list-item>
                <v-textarea :style="mobileView ? '' : 'width: 800px;'" label="Feedback (Optional)" prepend-icon="mdi-comment-text-outline" :rules="feedbackRules" v-model="feedback" outlined :disabled="isLoading"></v-textarea>
              </v-list-item>
                ...
                <div :style="mobileView ? '' : 'width: 800px;'">
                  ...
                  <v-card-text class="text-center">
                    ...
                    <span v-if="this.responseOk" class="text-green">
                      ...
                      Correo registrado. Te mantendremos informado.
                    </span>
