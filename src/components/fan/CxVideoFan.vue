<template>
    ...
    <div v-if="imageLoaded" class="d-flex justify-space-between">
      ...
      <div class="d-flex align-center">
        ...
        <div class="">
          <div class="text-caption truncate-text text-left pl-3 pt-2 mr-3">
            {{ title }}
          </div>
      ...
      <div class="pt-4">
        <v-menu>
          <template v-slot:activator="{ props: activatorProps }">
            <v-btn variant="text" prepend-icon="mdi-dots-vertical" width="24" height="36" size="x-medium" v-bind="activatorProps" class="py-1 align-center d-flex justify-end"></v-btn>
          </template>
