<template>
<v-container fluid>
    <v-list-item :active="activeItem === 'community'" v-slot:prepend="" class="my-4">
    ...
    <v-row>
        <v-col v-for="(img, index) in images" :key="index" cols="12" sm="6" md="4" lg="3" xl="2">
            <v-img :lazy-src="img.lazySrc" :src="img.src" alt="Image" class="mb-2" aspect-ratio="16/9" rounded="lg" @loadstart="loading[index] = true" @load="loading[index] = false">
